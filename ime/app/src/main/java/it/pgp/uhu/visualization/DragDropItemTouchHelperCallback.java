...
public class DragDropItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    final LinkedList arrayList;

    public DragDropItemTouchHelperCallback(ClipboardAdapter adapter, LinkedList arrayList) {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        if(viewHolder.getItemViewType() == ClipboardAdapter.HEADERVIEW)
